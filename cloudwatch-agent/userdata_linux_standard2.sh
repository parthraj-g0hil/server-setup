...
# Determine the CloudWatch agent package URL and type
case "$OS_ID" in
    amzn)
        OS="amazon_linux"
        PKG_TYPE="rpm"
...
if [[ "$PKG_TYPE" == "rpm" ]]; then
    ...
    curl -sSL -o /tmp/cwagent.deb "$URL"
...
# Show and apply config
echo "CloudWatch config written to /tmp/cwconfig.json:"
